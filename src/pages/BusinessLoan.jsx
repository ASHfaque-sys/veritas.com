    ...
    return (
        <div className="min-h-screen bg-cream flex flex-col">
            ...
            <main className="flex-1 max-w-2xl mx-auto w-full px-4 sm:px-6 py-10 fade-in">
                <button onClick={() => navigate('/')} className="flex items-center gap-1.5 text-sm text-gray-400 hover:text-gray-700 mb-6 transition-colors">
                    <ChevronLeft size={16} /> Back
                </button>

                <div className="mb-8">
                    <h1 className="section-title">Business Loan Eligibility</h1>
                    <p className="text-sm text-gray-500 mt-1">Select your loan type and upload financial documents for AI analysis.</p>
                </div>
